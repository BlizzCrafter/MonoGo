...
using Monofoxe.Extended.Pipeline.SpriteGroup.AST;
using System;
using static Monofoxe.Extended.Pipeline.SpriteGroup.AST.SpriteGroupMathTokenizer;

namespace Monofoxe.Extended.Pipeline.SpriteGroup
{
	/// <summary>
