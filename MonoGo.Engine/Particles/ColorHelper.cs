...
namespace MonoGo.Engine.Particles
{
    public static class ColorHelper
    {
        ...
        public static Colour InverseColour(this Colour colour)
        {
            return new Colour(360 - colour.H, colour.S, colour.L);
        }

        public static Colour OppositeColour(this Colour colour)
        {
            return new Colour((colour.H + 180) % 360, colour.S, colour.L);
        }
    }
}
