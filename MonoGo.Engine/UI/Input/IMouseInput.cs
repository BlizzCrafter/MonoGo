...
//-----------------------------------------------------------------------------
// Define the mouse-based input interface. This is the object MonoGo.Engine.UI uses
...
namespace MonoGo.Engine.UI
{
    ...
    /// <summary>
    /// Define the interface MonoGo.Engine.UI uses to get mouse or mouse-like input from users.
    /// </summary>
