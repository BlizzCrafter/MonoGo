...
namespace MonoGo.Engine.UI.Controls
{
    ...
    public class TextInput : Panel
    {
        ...
        public int InsertCharacters(string characters)
        {
            ...
            if (characters == "\b") { return 0; }       //Backspace
            if (characters == "\u007f") { return 0; }   //Delete
        ...
        internal override void DoInteractions(InputState inputState)
        {
            ...
            if (_isEditing)
            {
                ...
                if (!string.IsNullOrEmpty(Input.KeyboardString))
                {
                    InsertCharacter(Input.KeyboardString);
                    didType = true;
                }
                ...
                if (inputState.TextInputCommands != null)
                {
                    if (Value.Length > 0)
                    {
                        ...
                        {
                            // backspace
                            if (cmd == TextInputCommands.Backspace)
                            {
                                try
                                {
                            ...
                            // delete
                            else if (cmd == TextInputCommands.Delete)
                            {
                                try
                                {
                                    if (CaretOffset < Value.Length)
                            ...
                            // move caret left
                            else if (cmd == TextInputCommands.MoveCaretLeft)
                            {
                                CaretOffset--;
                            }
                            // move caret right
                            else if (cmd == TextInputCommands.MoveCaretRight)
                            {
                                CaretOffset++;
                            }
                            // move caret up
                            else if (cmd == TextInputCommands.MoveCaretUp)
                            {
                            ...
                            // move caret down
                            else if (cmd == TextInputCommands.MoveCaretDown)
                            {
                            ...
                            // move caret to end
                            else if (cmd == TextInputCommands.MoveCaretEnd)
                            {
                                CaretOffset = Value.Length;
                            }
                            // move caret to home
                            else if (cmd == TextInputCommands.MoveCaretStart)
                            {
                                CaretOffset = 0;
                            }
                            // move caret to start of line
                            else if (cmd == TextInputCommands.MoveCaretEndOfLine)
                            {
                                MoveCaretToEndOfLine();
                            }
                            // move caret to end of line
                            else if (cmd == TextInputCommands.MoveCaretStartOfLine)
                            {
                                MoveCaretToStartOfLine();
                            }
                            // break line
                            else if (cmd == TextInputCommands.BreakLine)
                            {
                                InsertCharacter('\n');
                            }
