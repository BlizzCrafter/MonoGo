...
// To use MonoGo.Engine.UI you first need to create an instance of this class and
...
{
    /// <summary>
    /// MonoGo.Engine.UI provides a simple yet extensive UI framework for MonoGame based projects.
    /// This is the main MonoGo.Engine.UI namespace. It contains the UserInterface manager and other important helpers.
    /// </summary>
    ...
    public delegate void EventCallback(EntityUI entity);
    ...
    public delegate EntityUI GenerateTooltipFunc(EntityUI entity);
    ...
    /// <summary>
    /// Main MonoGo.Engine.UI class that manage and draw all the UI entities.
    /// This is the main manager you use to update, draw, and add entities to.
    /// </summary>
    public class UserInterface : System.IDisposable
    {
        /// <summary>Current MonoGo.Engine.UI version identifier.</summary>
        ...
        /// <summary>
        /// The object that provide mouse input for MonoGo.Engine.UI.
        ...
        /// <summary>
        /// The object that provide keyboard and typing input for MonoGo.Engine.UI.
        ...
        /// <summary>
        /// If true, MonoGo.Engine.UI will not raise exceptions on sanity checks, validations, and errors which are not critical.
        ...
        /// MonoGo.Engine.UI entities use this method when need to create a paragraph, so you can override this to change which paragraph type the built-in
        ...
        static private EntityUI DefaultGenerateTooltipFunc(EntityUI source)
        {
            ...
            tooltip.BeforeDraw += (EntityUI ent) =>
            {
        ...
        private void UpdateTooltipText(EntityUI target)
        {
            ...
            if (_tooltipEntity == null)
            {
                ...
                _timeUntilTooltip += (float)TimeKeeper.Global.Time();
        ...
        {
            return new XmlSerializer(Root.GetType(), EntityUI._serializableTypes.ToArray());
        }
