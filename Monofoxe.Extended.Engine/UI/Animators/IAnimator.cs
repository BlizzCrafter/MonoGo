...
namespace Monofoxe.Extended.UI.Animators
{
    /// <summary>
    ...
    public abstract class IAnimator
    {
        ...
        /// </summary>
        public Entities.EntityUI TargetEntity { get; private set; }

        /// <summary>
        /// Set the entity this animator works on.
        /// </summary>
        /// <param name="entity">Target entity to animate.</param>
        internal void SetTargetEntity(Entities.EntityUI entity)
        {
        ...
        public virtual bool CheckEntityCompatibility(Entities.EntityUI entity)
        {
            return true;
        }
