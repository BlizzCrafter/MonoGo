...
using Monofoxe.Extended.UI.Entities.TextValidators;
...
namespace Monofoxe.Extended.UI.Entities
{
    ...
    public class TextInput : PanelBase
    {
        ...
        static TextInput()
        {
            EntityUI.MakeSerializable(typeof(TextInput));
        }
        ...
        {
            // animate caret
            _caretAnim += (float)TimeKeeper._elapsedTime * CaretBlinkingSpeed;
