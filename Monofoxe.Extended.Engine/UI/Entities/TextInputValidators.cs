...
namespace Monofoxe.Extended.UI.Entities.TextValidators
{
    /// <summary>
    ...
    public class TextValidatorNumbersOnly : ITextValidator
    {
        ...
        {
            EntityUI.MakeSerializable(typeof(TextValidatorNumbersOnly));
        }
    ...
    public class TextValidatorEnglishCharsOnly : ITextValidator
    {
        ...
        {
            EntityUI.MakeSerializable(typeof(TextValidatorEnglishCharsOnly));
        }
    ...
    public class SlugValidator : ITextValidator
    {
        ...
        {
            EntityUI.MakeSerializable(typeof(SlugValidator));
        }
    ...
    public class OnlySingleSpaces : ITextValidator
    {
        ...
        {
            EntityUI.MakeSerializable(typeof(OnlySingleSpaces));
        }
    ...
    public class TextValidatorMakeTitle : ITextValidator
    {
        ...
        {
            EntityUI.MakeSerializable(typeof(TextValidatorMakeTitle));
        }
