...
namespace Monofoxe.Extended.UI.Utils
{
    /// <summary>
    ...
    public static class PanelsGrid
    {
        ...
        public static Panel[] GenerateColums(int amount, EntityUI parent, Vector2? columnSize = null, PanelSkin skin = PanelSkin.None)
        {
        ...
        /// <param name="skin">Panels skin to use (default to None, making them invisible.</param>
        /// <returns>Array with generated panels.</returns>
        public static Panel[] GenerateColums(Vector2[] panelSizes, EntityUI parent, PanelSkin skin = PanelSkin.None)
        {
            // list of panels to return
            List<Panel> retList = new List<Panel>();
