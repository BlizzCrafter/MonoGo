...
namespace Monofoxe.Extended.Pipeline.Tiled
{
	[ContentTypeWriter]
	public class TiledMapWriter : ContentTypeWriter<TiledMap>
	{
		...
		public override string GetRuntimeType(TargetPlatform targetPlatform) =>
			"Monofoxe.Extended.Tiled.MapStructure.TiledMap, Monofoxe.Extended.Tiled";



		public override string GetRuntimeReader(TargetPlatform targetPlatform) =>
			"Monofoxe.Extended.Tiled.ContentReaders.TiledMapReader, Monofoxe.Extended.Tiled";
	}
}
