...
namespace Monofoxe.Extended.Pipeline.ResourceInfo
{
	/// <summary>
	/// Asset info importer. Reads .mcgb file and extracts all asset paths.
	/// </summary>
	[ContentImporter(".npl", DisplayName = "Resource Info Importer - Monofoxe.Extended", DefaultProcessor = "PassThroughProcessor")]
