...
// To use MonoGo.GUI you first need to create an instance of this class and
...
namespace MonoGo.GUI
{
    /// <summary>
    /// MonoGo.GUI provides a simple yet extensive UI framework for MonoGame based projects.
    /// This is the main MonoGo.GUI namespace. It contains the UserInterface manager and other important helpers.
    /// </summary>
    ...
    /// <summary>
    /// Main MonoGo.GUI class that manage and draw all the UI entities.
    /// This is the main manager you use to update, draw, and add entities to.
    /// </summary>
    public class UserInterface : System.IDisposable
    {
        /// <summary>Current MonoGo.GUI version identifier.</summary>
        ...
        /// <summary>
        /// The object that provide mouse input for MonoGo.GUI.
        ...
        /// <summary>
        /// The object that provide keyboard and typing input for MonoGo.GUI.
        ...
        /// <summary>
        /// If true, MonoGo.GUI will not raise exceptions on sanity checks, validations, and errors which are not critical.
        ...
        /// MonoGo.GUI entities use this method when need to create a paragraph, so you can override this to change which paragraph type the built-in
