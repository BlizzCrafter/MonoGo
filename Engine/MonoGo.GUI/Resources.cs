...
// MonoGo.GUI needs. If you edit and add new files to content, you probably
...
namespace MonoGo.GUI
{
    ...
    public class TexturesGetter<TEnum> where TEnum : Enum, IConvertible
    {
        ...
        /// </summary>
        /// <param name="path">Resource path, under MonoGo.GUI content.</param>
    ...
    public class Resources
    {
        ...
        /// <summary>Root for MonoGo.GUI content</summary>
        internal string _root;

        /// <summary>
        /// Load all MonoGo.GUI resources.
        /// </summary>
