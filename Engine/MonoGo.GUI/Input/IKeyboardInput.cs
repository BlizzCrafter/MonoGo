...
//-----------------------------------------------------------------------------
// Define the keyboard-based input interface. This is the object MonoGo.GUI uses
// to detect typing and key pressing.
// To support alternative keyboard-like input, inherit from this interface and
// and provide your alternative instance to the interface manager of MonoGo.GUI.
//
// Author: Ronen Ness.
// Since: 2018.
//-----------------------------------------------------------------------------
...
namespace MonoGo.GUI
{
    ...
    /// <summary>
    /// Define the interface MonoGo.GUI uses to get keyboard and typing input from users.
    /// </summary>
