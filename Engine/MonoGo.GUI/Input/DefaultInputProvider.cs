...
//-----------------------------------------------------------------------------
// Helper utility that implements default mouse and keyboard input for MonoGo.GUI.
...
{
    /// <summary>
    /// Implement Mouse Input and Keyboard Input for MonoGo.GUI + provide some helpful utils you can use externally.
    /// This is the object we provide to MonoGo.GUI by default, if no other input providers were set by user.
    /// </summary>
    public class DefaultInputProvider : IMouseInput, IKeyboardInput
    {
        ...
        /// If used outside MonoGo.GUI, this function should be called first thing inside your game 'Update()' function,
