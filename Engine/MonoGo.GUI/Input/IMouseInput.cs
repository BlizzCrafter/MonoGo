...
//-----------------------------------------------------------------------------
// Define the mouse-based input interface. This is the object MonoGo.GUI uses
...
namespace MonoGo.GUI
{
    ...
    /// <summary>
    /// Define the interface MonoGo.GUI uses to get mouse or mouse-like input from users.
    /// </summary>
