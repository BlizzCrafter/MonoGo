...
namespace MonoGo.GUI.Entities
{
    ...
    /// </summary>
    [System.Serializable]
    public class DropDown : EntityUI
    {
        /// <summary>
        /// Static ctor.
        /// </summary>
        static DropDown()
        {
            EntityUI.MakeSerializable(typeof(DropDown));
        }
        ...
        private void InitEvents()
        {
            ...
            _selectList.OnValueChange = (EntityUI entity) =>
            {
                // hide list
                ListVisible = false;
            ...
            _selectList.OnClick = (EntityUI entity) =>
            {
                ListVisible = false;
            };
            ...
            _selectedTextPanel.OnClick = (EntityUI self) =>
            {
                // change visibility
