...
namespace MonoGo.GUI.Entities
{
    ...
    /// </summary>
    [System.Serializable]
    public class PanelTabs : EntityUI
    {
        /// <summary>
        /// Static ctor.
        /// </summary>
        static PanelTabs()
        {
            EntityUI.MakeSerializable(typeof(PanelTabs));
        }
        ...
        internal protected override void InitAfterDeserialize()
        {
            ...
            // rebuild tabs
            var buttons = new List<EntityUI>(_buttonsPanel._children);
            _buttonsPanel.ClearChildren();
            var panels = new List<EntityUI>(_panelsPanel._children);
        ...
        private TabData AddTab(Panel newPanel, Button newButton)
        {
            ...
            newTab.button.OnValueChange = (EntityUI entity) => 
            {
