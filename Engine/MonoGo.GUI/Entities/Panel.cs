...
namespace MonoGo.GUI.Entities
{
    ...
    public class Panel : PanelBase
    {
        ...
        static Panel()
        {
            EntityUI.MakeSerializable(typeof(Panel));
        }
        ...
        override protected void UpdateChildren(ref EntityUI targetEntity, ref EntityUI dragTargetEntity, ref bool wasEventHandled, Point scrollVal)
        {
