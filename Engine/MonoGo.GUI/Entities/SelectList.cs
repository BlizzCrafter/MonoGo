...
namespace MonoGo.GUI.Entities
{
    ...
    public class SelectList : PanelBase
    {
        ...
        static SelectList()
        {
            EntityUI.MakeSerializable(typeof(SelectList));
        }
        ...
        {
            PropagateEventsTo((EntityUI)other);
            OnListChange += (EntityUI entity) => { other.OnListChange?.Invoke(other); };
        }
