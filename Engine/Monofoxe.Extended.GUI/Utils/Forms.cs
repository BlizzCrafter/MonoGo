...
namespace Monofoxe.Extended.GUI.Utils.Forms
{
    /// <summary>
    /// Form field types.
    /// </summary>
    ...
    public class FormFieldData
    {
        ...
        /// </summary>
        public System.Action<EntityUI> OnFieldCreated;
    ...
    public class Form
    {
        ...
        Dictionary<string, EntityUI> _entities = new Dictionary<string, EntityUI>();
        ...
        /// <returns></returns>
        protected virtual EntityUI CreateEntityForField(FormFieldData fieldData, ref bool needLabel)
        {
        ...
        public EntityUI GetEntity(string fieldId)
        {
