...
namespace MonoGo.Engine.UI.Entities.TextValidators
{
    /// <summary>
    /// MonoGo.Engine.UI.Entities.TextValidators contains different text validators and processors you can attach to TextInput entities.
    /// </summary>
