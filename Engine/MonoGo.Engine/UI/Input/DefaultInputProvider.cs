...
//-----------------------------------------------------------------------------
// Helper utility that implements default mouse and keyboard input for MonoGo.Engine.UI.
...
{
    /// <summary>
    /// Implement Mouse Input and Keyboard Input for MonoGo.Engine.UI + provide some helpful utils you can use externally.
    /// This is the object we provide to MonoGo.Engine.UI by default, if no other input providers were set by user.
    /// </summary>
    public class DefaultInputProvider : IMouseInput, IKeyboardInput
    {
        ...
        /// If used outside MonoGo.Engine.UI, this function should be called first thing inside your game 'Update()' function,
        ...
        public void Update(Vector2 mousePosition = default)
        {
            ...
            if (_keyboardInputCooldown > 0f)
            {
                ...
                _keyboardInputCooldown -= (float)TimeKeeper.Global.Time();
            }
