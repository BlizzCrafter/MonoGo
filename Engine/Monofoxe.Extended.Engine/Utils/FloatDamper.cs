...
namespace Monofoxe.Extended.Engine.Utils
{
	...
	public class FloatDamper
	{
		...
		private float _oldValue; // Previous input.
		private float _y, _yd; // State variables.
		...
		public float Update(float value, float speed)
		{
			if (_dirtyConstants)
			{
				ComputeConstants();
		...
		public FloatDamper Clone()
		{
			return new FloatDamper(
